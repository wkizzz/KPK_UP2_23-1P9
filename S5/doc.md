...
| code | Шифр направления подготовки | Да | string | 2-20 символов, формат 09.02.07 | — |
...
| head_phone | Телефон заведующего | Нет | string | формат +7XXXXXXXXXX | null |
| head_email | Email заведующего | Нет | string | формат email | null |
| head_cabinet_id | Номер кабинета заведующего | Нет | integer | положительное число | null |
