...
|----------|-----|-----------|
| result | boolean | `True` - отделение удалено, `False` - отделение не найдено |
...
| Параметр | Пояснение | Обязательность | Тип | Значение по умолчанию |
|----------|-----------|----------------|-----|----------------------|
| page | Номер страницы (пагинация) | Нет | integer | 1 |
| size | Количество записей на странице | Нет | integer | 10 |
